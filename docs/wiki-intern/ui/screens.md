...
| `pages/Analytics/` | Traffic-Übersicht (KPIs, Statuscodes, Listen) |
| `pages/Analytics/GeoIntelligence.tsx` | Geo-Intelligence mit Threat-Map, Hotspots, Regionen |
...
Analytics-Routen (Frontend-Phase 1):

- `/analytics` → allgemeine Traffic-/Performance-Analyse
- `/analytics/geo` → Geo-Intelligence (separate Unterseite)
